...
<div class="wrap">
  <div class="header">
    <div>
      <div class="title">🎙️ Voice Chat <span style="opacity:0.6; font-weight:600">· X-ASR · Granite-4.2-8B · Qwen3-TTS</span></div>
      <div class="subtitle">VAD Silero · STT X-ASR (sherpa 160ms) · LLM Granite-4.2-8B (native tools) · TTS Qwen3-TTS 0.6B CustomVoice Q8 24k · Svelte 5 + AudioWorklet</div>
    </div>
  ...
  <div class="grid">
    ...
    <div class="card">
      ...
      <div class="card" style="margin-top:12px; padding:12px; background:#0f0f14; border-color:#1f3d2b">
        <h3 style="margin-bottom:6px; color:#20c997">🔧 Granite-4.2-8B Tool Calling · web_search via self-hosted SearXNG</h3>
        <div style="font-size:12px; opacity:0.85; line-height:1.6">
          <b>Granite-4.2-8B</b> (Q4_K_S, native tools) multi-turn <code>tool_calls</code> → <code>web_search(query)</code> → <b>SearXNG</b> self-hosted (bing + wikipedia engines, entity-first queries) → <code>tool_response</code> → answer → spoken via <b>Qwen3-TTS 0.6B CustomVoice</b> (faster_qwen3_tts cu124 GGML, TRUE streaming, 24k).<br/>
      ...
      <div class="card" style="margin-top:12px; padding:12px; background:#0f0f14">
        ...
        <table style="width:100%; font-size:12px; border-collapse:collapse">
          ...
          <tr><td style="padding:5px 8px; opacity:0.7; border-bottom:1px solid #1e1e28">LLM</td><td style="padding:5px 8px; border-bottom:1px solid #1e1e28"><code>ibm-granite/granite-4.2-8b-GGUF</code> <span style="opacity:0.5">· 8B Q4_K_S, llama-server :11435, native tools=[web_search]</span></td></tr>
  ...
  <div style="text-align:center; font-size:11px; opacity:0.45; margin-top:16px">
    <span style="color:#20c997">● Real: Silero VAD + X-ASR + Granite-4.2-8B + Qwen3-TTS-Q8</span> · SearXNG self-hosted :8888 · <code>https://training-machine.tailf63b31.ts.net</code> · <code>wss</code> · No mock.
  </div>
</div>
